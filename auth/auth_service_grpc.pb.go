...
func (c *authServiceClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*structpb.Struct, error) {
...
func (UnimplementedAuthServiceServer) Health(context.Context, *emptypb.Empty) (*structpb.Struct, error) {
